        ...
        <div className='container'>
            <div className='row p-5 mt-5 mb-5'>
                ...
                <div className='col-4 p-5 mt-3 mb-5'>
                    <h5><i style={{marginRight:"3px"}} class="fa-solid fa-circle-plus"></i>Account Opening</h5>
                ...
                <div className='col-4 p-5 mt-3 mb-5'>
                    <h5><i style={{marginRight:"3px"}} class="fa-solid fa-user"></i>Your Zerodha Account</h5>
                ...
                <div className='col-4 p-5 mt-3 mb-5'>
                    <h5><i style={{marginRight:"3px"}} class="fa-solid fa-chart-column"></i>Your Zerodha Account</h5>
                 ...
                 <div className='col-4 p-5  mb-5'>
                    <h5><i style={{marginRight:"3px"}} class="fa-regular fa-credit-card"></i>Funds</h5>
                ...
                <div className='col-4 p-5  mb-5'>
                    <h5><i style={{marginRight:"3px"}} class="fa-solid fa-chart-column"></i>Console</h5>
                    ...
                    <a href='' style={{textDecoration:"none", lineHeight:"2.5"}}>60 Day Challeneg</a><br/>
                ...
                <div className='col-4 p-5  mb-5'>
                    <h5><i style={{marginRight:"3px"}} class="fa-solid fa-coins"></i>Coin</h5>
